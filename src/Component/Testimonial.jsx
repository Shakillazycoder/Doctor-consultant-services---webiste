          ...
          <div className="p-6">
            ...
            <div className="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
              <div className="relative flex items-center gap-4 pt-0 pb-8 mx-0 mt-4 overflow-hidden text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
                <img
                  src="https://i.ibb.co/dbnHXNW/portrait-successful-man-having-stubble-posing-with-broad-smile-keeping-arms-folded-171337-1267.jpg"
                  alt="Tania Andrew"
              ...
              <div className="p-0 mb-6">
                ...
                I was amazed by the professionalism and care I received during my telemedicine consultation. The doctor listened to my concerns attentively and provided clear advice. Highly recommended!
                </p>
              </div>
            </div>
          </div>
