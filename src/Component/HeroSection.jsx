...
const HeroSection = () => {
    return (
        <section className="bg-white dark:bg-[#f5f5f5] rounded-2xl mt-10">
    <div className="grid max-w-screen-2xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <a href="#" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-[#eef2f5] rounded-lg bg-[#3498db] hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
            Book a Consultation
